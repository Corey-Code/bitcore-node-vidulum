...
console.log('Vidulum Service native interface vs. Vidulum JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.vidulum',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('Vidulum started');
});

bitcoind.on('ready', function() {

  console.log('Vidulum ready');
