...
var BASE_PACKAGE = {
  description: 'A full Vidulum node build with Bitcore',
  repository: 'https://github.com/Corey-Code/bitcore-node-vidulum',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-vidulum': 'Corey-Code/bitcore-lib-vidulum',
    'bitcore-node-vidulum': 'Corey-Code/bitcore-node-vidulum'
  }
};
